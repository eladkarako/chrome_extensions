...
for %%f in (*.js) do (
  ...
  call "..\mods\Closure-Compiler\example4_ignore_undefined_variables__include_webext_globals__advanced__noprettyprint.cmd" "!JUST_PATH!!NAME_ORG!" "!JUST_PATH!!NAME_MIN!"
  if ["%ErrorLevel%"] NEQ ["0"] ( 
    pause
  ) 
  del /f /q "!NAME_ORG!"

  call "..\mods\javascript-obfuscator\javascript-obfuscator_minimum_obfuscation_config.cmd" "!JUST_PATH!!NAME_MIN!" "!JUST_PATH!!NAME_OBF!"
  if ["%ErrorLevel%"] NEQ ["0"] ( 
    pause
  ) 
  del /f /q "!NAME_MIN!"
